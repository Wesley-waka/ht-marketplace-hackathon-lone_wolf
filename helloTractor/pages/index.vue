        ...
        <div class="max-w-[84rem] px-6 mx-auto my-[100px]">
          ...
          <div class="flex flex-row justify-between my-32">
            ...
            <div class="w-[400px] flex flex-col justify-center align-middle">
              <div class=" mx-auto">
                <div class="">
                  <img src="../assets/images/speechBubble/HT_BRAND ASSETS_SOLID SPEECHBUBBLES_RGB_Sunset Blaze.png" class="h-[140px] w-[140px]" alt="">
                  <img src="../assets/images/speechBubble/HT_BRAND ASSETS_SOLID SPEECHBUBBLES_RGB_Plum.png" class="flip-horizontal h-[140px] w-[140px] ml-12" alt="">
                </div>
              </div>
              <h4>03.</h4>
          ...
          <div class="flex flex-row my-8 align-middle">
            ...
            <div class="flex flex-col space-y-6 my-auto">
              <div>
                ...
                <p>Carvago will even finance cars from abroad, which is rare. Furthermore, we are able to do so purely online and within few hours. Try out our financing calculator - there is no hidden fine print!</p>
              </div>
          ...
          <Card style="width: 23rem; height: 18rem; overflow: hidden; padding: 10px;">
            <template #content>
              <div class="flex flex-col justify-center align-middle">
                <img alt="user header" class="w-[78px] h-[78px] bg-[#ecfcff] p-4 rounded-full mx-auto" src="/caraudit.svg" />
                <div class="mx-auto mt-4">Deal Allocators</div>
              </div>
              <div class="mt-4 mx-3 flex-col space-y-1">
                <div class="flex flex-row space-x-2">
                  <img src="/White/HT_ICONS_WHITE_RGB-39.png" alt="" class=" rounded-full w-[20px] h-[20px] bg-[#ff461e]">
